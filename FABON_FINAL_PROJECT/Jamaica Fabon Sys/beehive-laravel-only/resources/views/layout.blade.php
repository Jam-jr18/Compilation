...
<head>
    ...
    <title>@yield('title', 'BeeHive Restobar')</title>
    @stack('head')
    <style>
...
<body>
    <div class="portal-hotspot no-print"><a href="{{ route('portal') }}" title="portal"></a></div>
    <header class="topbar no-print">
        <div class="wrap nav">
            <a class="brand" href="{{ route('home') }}"><span class="logo">🐝</span><span>BeeHive<br><small class="muted">Restobar System</small></span></a>
            <nav class="links">
                <a href="{{ route('home') }}">Order</a>
                <a href="{{ route('orders.track.form') }}">Track Order</a>
                <a href="{{ route('portal') }}">Staff / Admin</a>
            </nav>
            <a class="btn honey mobile-only" href="{{ route('portal') }}">portal</a>
        </div>
    </header>
