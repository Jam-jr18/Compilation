<?php $__env->startSection('title', 'beehive admin dashboard'); ?>
...
<div class="admin-shell">
    <header class="admin-header">
        ...
        <div class="admin-actions">
            ...
            <a class="export-btn" href="<?php echo e(route('admin.reports.sales', ['period' => 'year'])); ?>">⇩ Export Sales</a>
            <nav class="admin-tabs">
                <a class="active" href="<?php echo e(route('admin.dashboard')); ?>">Analytics</a>
                <a href="<?php echo e(route('admin.menu')); ?>">Menu</a>
                <a href="<?php echo e(route('admin.tables')); ?>">Tables</a>
                <a href="<?php echo e(route('admin.settings')); ?>">Settings</a>
                <form method="POST" action="<?php echo e(route('logout', 'admin')); ?>"><?php echo csrf_field(); ?><button>Logout</button></form>
            </nav>
        </div>
    </header>
    ...
    <main class="admin-main">
        <section class="stats-grid">
            <article class="stat-card"><div class="stat-icon green">$</div><div><div class="stat-label">Today Sales</div><div class="stat-value">₱<?php echo e(number_format($sales['today'], 0)); ?></div></div></article>
            <article class="stat-card"><div class="stat-icon blue">↗</div><div><div class="stat-label">Monthly Sales</div><div class="stat-value">₱<?php echo e(number_format($sales['month'], 0)); ?></div></div></article>
            <article class="stat-card"><div class="stat-icon purple">▥</div><div><div class="stat-label">Yearly Sales</div><div class="stat-value">₱<?php echo e(number_format($sales['year'], 0)); ?></div></div></article>
            <article class="stat-card"><div class="stat-icon orange">▣</div><div><div class="stat-label">Total Volume</div><div class="stat-value"><?php echo e($counts['total_volume'] ?? $recentOrders->count()); ?></div></div></article>
        </section>

        <section class="dashboard-grid">
            <article class="analytics-card">
                <div class="card-head"><h2>Today's Split</h2><span class="soft-icon">▦</span></div>
                <?php if(($counts['pending'] + $counts['preparing'] + $counts['ready'] + $counts['completed_today']) > 0): ?>
                    <div class="split-row"><span>Pending</span><strong><?php echo e($counts['pending']); ?></strong></div>
                    <div class="split-row"><span>Preparing</span><strong><?php echo e($counts['preparing']); ?></strong></div>
                    <div class="split-row"><span>Ready</span><strong><?php echo e($counts['ready']); ?></strong></div>
                    <div class="split-row"><span>Completed</span><strong><?php echo e($counts['completed_today']); ?></strong></div>
                <?php else: ?>
                ...
                <table class="data-table">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td><span class="mini-badge <?php echo e($order->status); ?>"><?php echo e($order->status); ?></span></td>
                            <td><strong>₱<?php echo e(number_format($order->total, 0)); ?></strong></td>
                        </tr>
        ...
        <section class="dashboard-grid bottom">
            <article class="analytics-card">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $topItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="favorite-row"><span><?php echo e($item->item_name); ?> <small class="muted">x<?php echo e($item->quantity); ?></small></span><strong>₱<?php echo e(number_format($item->total, 0)); ?></strong></div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <article class="analytics-card">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $categorySales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="category-row"><span><?php echo e($row->category); ?></span><strong>₱<?php echo e(number_format($row->total, 0)); ?></strong></div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Jamaica Rose Fabon\Downloads\Jamaica Fabon Sys\beehive-laravel-only\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>